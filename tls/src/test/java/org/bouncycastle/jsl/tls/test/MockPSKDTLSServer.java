...
import org.bouncycastle.jsl.tls.PSKTlsServer;
...
import org.bouncycastle.jsl.tls.TlsPSKIdentityManager;
    ...
    extends PSKTlsServer
{
    ...
    {
        super(org.bouncycastle.jsl.tls.test.TlsTestUtils.createTestCrypto(), new MyIdentityManager(badKey));
    }
