...
public class DTLSServerTest
{
        ...
        throws Exception
    {
        ...
        TlsCrypto serverCrypto = org.bouncycastle.jsl.tls.test.TlsTestUtils.createTestCrypto();
