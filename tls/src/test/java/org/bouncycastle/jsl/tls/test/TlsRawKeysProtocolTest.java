...
import org.bouncycastle.jsl.tls.TlsClient;
import org.bouncycastle.jsl.tls.TlsClientProtocol;
...
public abstract class TlsRawKeysProtocolTest
    extends TestCase
{
    ...
    protected abstract TlsCrypto createCrypto();
