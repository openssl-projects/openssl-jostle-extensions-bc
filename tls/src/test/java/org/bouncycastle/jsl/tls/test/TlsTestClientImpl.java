...
import org.bouncycastle.jsl.tls.ConnectionEnd;
    ...
    extends DefaultTlsClient
{
        ...
        return new TlsAuthentication()
        {
                ...
                throws IOException
            {
                ...
                return new TlsCredentialedSigner()
                {
                    ...
                    public org.bouncycastle.jsl.tls.Certificate getCertificate()
                    {
                        org.bouncycastle.jsl.tls.Certificate cert = signerCredentials.getCertificate();
    ...
    protected org.bouncycastle.jsl.tls.Certificate corruptCertificate(org.bouncycastle.jsl.tls.Certificate cert)
    {
        ...
        return new org.bouncycastle.jsl.tls.Certificate(cert.getCertificateRequestContext(), certEntryList);
    }
