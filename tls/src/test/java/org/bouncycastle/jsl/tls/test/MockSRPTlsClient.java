...
import org.bouncycastle.jsl.tls.SRPTlsClient;
...
import org.bouncycastle.jsl.tls.TlsSRPIdentity;
    ...
    extends SRPTlsClient
{
    ...
    {
        super(org.bouncycastle.jsl.tls.test.TlsTestUtils.createTestCrypto(), srpIdentity);
