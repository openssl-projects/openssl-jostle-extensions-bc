...
import org.bouncycastle.jsl.tls.TlsFatalAlertReceived;
import org.bouncycastle.jsl.tls.TlsServer;
...
//    }
    ...
    /**
     * The raw-key scenarios are Ed25519/Ed448, which a FIPS module need not carry. A TestCase
     * subclass cannot skip via Assume, so the whole class returns early instead.
     */
    ...
    {
        return TlsTestUtils.createTestCrypto();
    }
