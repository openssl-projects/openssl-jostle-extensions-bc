    ...
    extends TestCase
{
    ...
    // BCJcaJceHelper resolves through BouncyCastleProvider, which does not exist here.
    // NamedJcaJceHelper on the installed provider is the same thing for this fork.
    private static final JcaJceHelper HELPER = new NamedJcaJceHelper(JslTestProvider.name());
    ...
    private static KeyPair generateKeyPair()
        throws Exception
    {
        KeyPairGenerator kpg = KeyPairGenerator.getInstance("EC", JslTestProvider.name());
        kpg.initialize(256);
        ...
        throws Exception
    {
        ...
        ContentSigner signer = new JcaContentSignerBuilder("SHA256withECDSA")
            .setProvider(JslTestProvider.name()).build(issuerKey);
