...
public class BouncyCastleJsseProvider
    extends Provider
{
    public static final String PROVIDER_NAME = "JSLJSSE";

    private static final String JSSE_CONFIG_PROPERTY = "org.bouncycastle.jsl.jsse.config";
    ...
    private void configure()
    {
        ...
        addAlgorithmImplementation("KeyManagerFactory.X.509", "org.bouncycastle.jsl.jsse.provider.KeyManagerFactory", 
            new EngineCreator()
            {
        ...
        addAlgorithmImplementation("TrustManagerFactory.PKIX", "org.bouncycastle.jsl.jsse.provider.TrustManagerFactory", 
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.TLS", "org.bouncycastle.jsl.jsse.provider.SSLContext.TLS",
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.TLSV1", "org.bouncycastle.jsl.jsse.provider.SSLContext.TLSv1",
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.TLSV1.1", "org.bouncycastle.jsl.jsse.provider.SSLContext.TLSv1_1",
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.TLSV1.2", "org.bouncycastle.jsl.jsse.provider.SSLContext.TLSv1_2",
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.TLSV1.3", "org.bouncycastle.jsl.jsse.provider.SSLContext.TLSv1_3",
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.DEFAULT", "org.bouncycastle.jsl.jsse.provider.SSLContext.Default",
            new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                    throws GeneralSecurityException
