    ...
    static
    {
...

        {
            ...
            try
            {
                ...
                if (null != methods)
                {
                    String className = "org.bouncycastle.jsl.jsse.provider.ExportX509TrustManager_7";
...

        {
            ...
            if (null != x509ExtendedTrustManagerClass)
            {
                try
                {
                    String className = "org.bouncycastle.jsl.jsse.provider.ImportX509TrustManager_7";
