...

        {
            ...
            try
            {
                ...
                if (null != methods)
                {
                    ...
                    {
                        className = "org.bouncycastle.jsl.jsse.provider.ExportSSLSession_8";
                    }
                    else
                    {
                        className = "org.bouncycastle.jsl.jsse.provider.ExportSSLSession_7";
                    }
            ...
            if (null != extendedSSLSessionClass)
            {
                try
                {
                    ...
                    if (null != methods)
                    {
                        ...
                        if (ReflectionUtil.hasMethod(methods, "getRequestedServerNames"))
                        {
                            className = "org.bouncycastle.jsl.jsse.provider.ImportSSLSession_8";
                        }
                        else
                        {
                            className = "org.bouncycastle.jsl.jsse.provider.ImportSSLSession_7";
                        }
