...
import org.bouncycastle.jsl.jsse.BCX509ExtendedKeyManager;
import org.bouncycastle.jsl.jsse.BCX509ExtendedTrustManager;
import org.bouncycastle.jsl.jsse.java.security.BCAlgorithmConstraints;
...
final class ContextData
{
        ...
        String[] defaultCipherSuitesServer, String[] defaultProtocolsClient, String[] defaultProtocolsServer)
    {
        ...
        this.handshakeTimeoutMillis = PropertyUtils.getIntegerSystemProperty(
            "org.bouncycastle.jsl.jsse.handshakeTimeoutMillis", 0, 0, Integer.MAX_VALUE);
        /*
        ...
        this.defaultUseNamedGroupsOrder = PropertyUtils.getBooleanSystemProperty(
            "org.bouncycastle.jsl.jsse.useNamedGroupsOrder", false);
    }
...
//        String[] enabledCipherSuites = sslParameters.getCipherSuitesArray();
     ...
     * in this context, from <code>org.bouncycastle.jsl.jsse.useNamedGroupsOrder</code> (default false).
     */
