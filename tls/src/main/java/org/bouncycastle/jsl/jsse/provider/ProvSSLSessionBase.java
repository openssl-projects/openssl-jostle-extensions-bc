    ...
    extends BCExtendedSSLSession
{
    ...
    protected abstract org.bouncycastle.jsl.tls.Certificate getLocalCertificateTLS();

    protected abstract org.bouncycastle.jsl.tls.Certificate getPeerCertificateTLS();
