...
import org.bouncycastle.jsl.tls.crypto.TlsCertificateRole;
import org.bouncycastle.jsl.tls.crypto.TlsEncryptor;
import org.bouncycastle.jsl.tls.crypto.TlsVerifier;
import org.bouncycastle.jsl.tls.crypto.impl.LegacyTls13Verifier;
import org.bouncycastle.jsl.tls.crypto.impl.PQCUtil;
import org.bouncycastle.jsl.tls.crypto.impl.RSAUtil;
...
//        }
    ...
    public Tls13Verifier createVerifier(int signatureScheme) throws IOException
    {
        ...
        case SignatureScheme.ecdsa_sha1:
        {
            ...
            String sigName = org.bouncycastle.jsl.tls.crypto.impl.jcajce.RSAUtil.getDigestSigAlgName(digestName)
                + "WITHECDSA";
        ...
        case SignatureScheme.rsa_pss_pss_sha512:
        {
            ...
            AlgorithmParameterSpec pssSpec = org.bouncycastle.jsl.tls.crypto.impl.jcajce.RSAUtil.getPSSParameterSpec(
