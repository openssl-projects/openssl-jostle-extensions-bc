...
import org.bouncycastle.jsl.tls.CertificateType;
import org.bouncycastle.jsl.tls.DigitallySigned;
import org.bouncycastle.jsl.tls.EncryptionAlgorithm;
import org.bouncycastle.jsl.tls.HashAlgorithm;
import org.bouncycastle.jsl.tls.MACAlgorithm;
...
import org.bouncycastle.jsl.tls.TlsDHUtils;
import org.bouncycastle.jsl.tls.TlsFatalAlert;
import org.bouncycastle.jsl.tls.TlsUtils;
import org.bouncycastle.jsl.tls.crypto.CryptoHashAlgorithm;
import org.bouncycastle.jsl.tls.crypto.CryptoSignatureAlgorithm;
import org.bouncycastle.jsl.tls.crypto.SRP6Group;
import org.bouncycastle.jsl.tls.crypto.Tls13Verifier;
import org.bouncycastle.jsl.tls.crypto.TlsCertificate;
import org.bouncycastle.jsl.tls.crypto.TlsCipher;
import org.bouncycastle.jsl.tls.crypto.TlsCryptoException;
import org.bouncycastle.jsl.tls.crypto.TlsCryptoParameters;
import org.bouncycastle.jsl.tls.crypto.TlsCryptoUtils;
import org.bouncycastle.jsl.tls.crypto.TlsDHConfig;
import org.bouncycastle.jsl.tls.crypto.TlsDHDomain;
import org.bouncycastle.jsl.tls.crypto.TlsECConfig;
import org.bouncycastle.jsl.tls.crypto.TlsECDomain;
import org.bouncycastle.jsl.tls.crypto.TlsHMAC;
import org.bouncycastle.jsl.tls.crypto.TlsHash;
import org.bouncycastle.jsl.tls.crypto.TlsKemConfig;
import org.bouncycastle.jsl.tls.crypto.TlsKemDomain;
import org.bouncycastle.jsl.tls.crypto.TlsNonceGenerator;
import org.bouncycastle.jsl.tls.crypto.TlsSRP6Client;
import org.bouncycastle.jsl.tls.crypto.TlsSRP6Server;
import org.bouncycastle.jsl.tls.crypto.TlsSRP6VerifierGenerator;
...
import org.bouncycastle.jsl.tls.crypto.impl.AbstractTlsCrypto;
import org.bouncycastle.jsl.tls.crypto.impl.Tls13NullCipher;
import org.bouncycastle.jsl.tls.crypto.impl.TlsAEADCipher;
import org.bouncycastle.jsl.tls.crypto.impl.TlsAEADCipherImpl;
import org.bouncycastle.jsl.tls.crypto.impl.TlsBlockCipher;
import org.bouncycastle.jsl.tls.crypto.impl.TlsBlockCipherImpl;
import org.bouncycastle.jsl.tls.crypto.impl.TlsImplUtils;
import org.bouncycastle.jsl.tls.crypto.impl.TlsNullCipher;
import org.bouncycastle.jsl.tls.crypto.impl.jcajce.srp.SRP6Client;
import org.bouncycastle.jsl.tls.crypto.impl.jcajce.srp.SRP6Server;
import org.bouncycastle.jsl.tls.crypto.impl.jcajce.srp.SRP6VerifierGenerator;
    ...
    extends AbstractTlsCrypto
{
    ...
    public boolean hasSignatureAlgorithm(short signatureAlgorithm)
    {
        ...
        // JSL now provides DSA (see openssl-jostle DSA_SUPPORT.md), so advertise it like stock bc-java.
        case SignatureAlgorithm.dsa:
            return true;

        // JSL still has no GOST, so unlike stock bc-java we must NOT advertise these — otherwise the
        // TLS layer offers/selects a scheme the provider can't honour (and the signer-credential
        // load fails trying to build the KeyFactory).
        // TODO[RFC 9189]
