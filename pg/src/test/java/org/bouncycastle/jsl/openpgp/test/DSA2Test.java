...
import org.bouncycastle.jsl.test.PrintTestResult;
    ...
    extends TestCase
{
    ...
    // DISABLED: OpenSSL's DSA verify rejects these oversized domain params
    // ("dsa routines:dsa_do_verify:bad q value"); q of 384/512 bits is outside what
    // the OpenSSL DSA path accepts. Standard params (1024/2048/3072, above) verify fine.
    public void DISABLED_testK7680H384()
        throws Exception
    {
    ...
    // DISABLED: the .sec keyrings are PBE-protected with CAST5, which JSL does not
    // provide, so extractPrivateKey fails before any DSA signing happens.
    public void DISABLED_testGenerateK1024H224()
        throws Exception
    {
