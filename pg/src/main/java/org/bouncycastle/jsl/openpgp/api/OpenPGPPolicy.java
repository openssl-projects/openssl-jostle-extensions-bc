...
public interface OpenPGPPolicy
{
     ...
     * {@link org.bouncycastle.jsl.bcpg.SignatureSubpacketInputStream}.
     *
     ...
     * {@link org.bouncycastle.jsl.util.io.StreamOverflowException} (an {@link java.io.IOException})
     * from reading the {@link OpenPGPMessageInputStream message input stream}.
     * </p><p>
     * This mirrors the {@link org.bouncycastle.jsl.openpgp.PGPCompressedData#getDataStream()} /
     * {@link org.bouncycastle.jsl.openpgp.PGPCompressedData#getDataStream(long)} pair on the
