...
import org.bouncycastle.jsl.openpgp.operator.PGPS2KCalculator;
 ...
 * is derived through the provider's {@code SecretKeyFactory.ARGON2} (RFC 9106) rather than a
 * lightweight engine, so the provider is overridable via {@link #setProvider}. The cost
