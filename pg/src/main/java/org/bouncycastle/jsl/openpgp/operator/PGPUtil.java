...
{
    // Property names as used by bc-java's Argon2Parameters (MAX_MEMORY_EXP / MAX_PASSES / MAX_PARALLELISM).
    // They are referenced here as plain strings so that this top-level operator class does not depend on a
    // software Argon2 implementation - the Argon2 cost clamp is policy on untrusted packet data and must
    // run here, before any backend.
    private static final String MAX_MEMORY_EXP = "org.bouncycastle.jsl.argon2.max_memory_exp";
    private static final String MAX_PASSES = "org.bouncycastle.jsl.argon2.max_passes";
    private static final String MAX_PARALLELISM = "org.bouncycastle.jsl.argon2.max_parallelism";
