...
import org.bouncycastle.jsl.openpgp.api.OpenPGPCertificate;
import org.bouncycastle.jsl.util.Arrays;

/**
 * Exception that gets thrown if the user tries to encrypt a message for an
 * {@link org.bouncycastle.jsl.openpgp.api.OpenPGPCertificate} that does not contain any usable, valid encryption keys.
 */
