package org.bouncycastle.jsl.openpgp.api.jcajce;
...
import org.bouncycastle.jsl.crypto.CryptoServicesRegistrar;
...
import org.bouncycastle.jsl.openpgp.api.OpenPGPImplementation;
...
import org.bouncycastle.jsl.openpgp.operator.PBEKeyEncryptionMethodGenerator;
...
import org.bouncycastle.jsl.openpgp.operator.PGPContentSignerBuilder;
import org.bouncycastle.jsl.openpgp.operator.PGPContentSignerBuilderProvider;
import org.bouncycastle.jsl.openpgp.operator.PGPContentVerifierBuilderProvider;
import org.bouncycastle.jsl.openpgp.operator.PGPDataEncryptorBuilder;
import org.bouncycastle.jsl.openpgp.operator.PGPDigestCalculatorProvider;
import org.bouncycastle.jsl.openpgp.operator.PGPKeyPairGeneratorProvider;
import org.bouncycastle.jsl.openpgp.operator.PublicKeyDataDecryptorFactory;
import org.bouncycastle.jsl.openpgp.operator.PublicKeyKeyEncryptionMethodGenerator;
import org.bouncycastle.jsl.openpgp.operator.SessionKeyDataDecryptorFactory;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcaAEADSecretKeyEncryptorFactory;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcaCFBSecretKeyEncryptorFactory;
...
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcaPGPContentSignerBuilderProvider;
...
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcePBEDataDecryptorFactoryBuilder;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcePBEKeyEncryptionMethodGenerator;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcePBESecretKeyDecryptorBuilderProvider;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcePGPDataEncryptorBuilder;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcePublicKeyDataDecryptorFactoryBuilder;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JcePublicKeyKeyEncryptionMethodGenerator;
import org.bouncycastle.jsl.openpgp.operator.jcajce.JceSessionKeyDataDecryptorFactoryBuilder;
        ...
        extends OpenPGPImplementation
{
    ...
    {
        // No hard-coded provider: the default JCA provider chain handles classic
        // PGP algorithms (RSA/AES/SHA). For PQC keys, construct with the JSL
        // provider explicitly via JcaOpenPGPImplementation(Provider, SecureRandom).
        this((Provider)null, CryptoServicesRegistrar.getSecureRandom());
    }
