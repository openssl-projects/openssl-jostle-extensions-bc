 ...
 *     <td>{@link org.bouncycastle.jsl.bcpg.SecretKeyPacket#USAGE_AEAD}</td>
 *     <td>RECOMMENDED; Argon2 MUST be used with AEAD</td>
 * </tr>
 * <tr>
 *     <td>{@link S2K#SALTED_AND_ITERATED}</td>
 *     <td>{@link org.bouncycastle.jsl.bcpg.SecretKeyPacket#USAGE_SHA1}</td>
 *     <td>MAY be used if Argon2 is not available; Take care to use high octet count + strong passphrase</td>
 * </tr>
 * <tr>
 *     <td>none</td>
 *     <td>{@link org.bouncycastle.jsl.bcpg.SecretKeyPacket#USAGE_NONE}</td>
 *     <td>Unprotected</td>
 * </tr>
 * </table>
 * <p>
