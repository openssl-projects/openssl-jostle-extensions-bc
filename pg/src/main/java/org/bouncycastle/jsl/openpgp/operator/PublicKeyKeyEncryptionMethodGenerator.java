...
import org.bouncycastle.jsl.bcpg.PublicKeyEncSessionPacket;
...
{
    public static final String SESSION_KEY_OBFUSCATION_PROPERTY = "org.bouncycastle.jsl.openpgp.session_key_obfuscation";
     ...
     * "org.bouncycastle.jsl.openpgp.session_key_obfuscation", or else it will default to enabled.
     * </p>
     *
     ...
     * PKESKv3 packets are used with keys that do not support {@link org.bouncycastle.jsl.bcpg.sig.Features#FEATURE_SEIPD_V2}
     * or as a fallback.
     * <p/>
     ...
     * of version 2 only.
     * PKESKv6 packets are used with keys that support {@link org.bouncycastle.jsl.bcpg.sig.Features#FEATURE_SEIPD_V2}.
     *
