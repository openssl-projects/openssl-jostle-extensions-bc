...
import org.bouncycastle.jsl.openpgp.api.jcajce.JcaOpenPGPImplementation;
...
public abstract class OpenPGPImplementation
{
    ...
    public static OpenPGPImplementation getInstance()
    {
        if (INSTANCE == null)
        {
            setInstance(new JcaOpenPGPImplementation());
        }
        return INSTANCE;
    }
     ...
     * concrete {@link org.bouncycastle.jsl.openpgp.operator.PGPDigestCalculator} implementations.
     *
