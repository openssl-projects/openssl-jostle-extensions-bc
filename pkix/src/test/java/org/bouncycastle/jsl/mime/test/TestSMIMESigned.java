package org.bouncycastle.jsl.mime.test;
...
import org.bouncycastle.jsl.mime.smime.SMIMESignedWriter;
import org.bouncycastle.jsl.mime.smime.SMimeParserListener;
import org.bouncycastle.jsl.mime.smime.SMimeParserProvider;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        MimeParserProvider provider = new SMimeParserProvider("7bit", new org.bouncycastle.jsl.operator.jcajce.JcaDigestCalculatorProviderBuilder().setProvider(JslTestProvider.name()).build());
        ...
        p.parse(new SMimeParserListener()
        {
                ...
                throws IOException
            {
                ...
                assertTrue(org.bouncycastle.jsl.util.Arrays.areEqual(messageContent, content));
            }
