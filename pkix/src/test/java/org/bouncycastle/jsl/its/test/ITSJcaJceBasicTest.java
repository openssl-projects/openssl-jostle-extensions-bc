package org.bouncycastle.jsl.its.test;
...
import org.bouncycastle.jsl.its.ITSPublicVerificationKey;
import org.bouncycastle.jsl.its.ITSValidityPeriod;
import org.bouncycastle.jsl.its.jcajce.JcaITSContentSigner;
import org.bouncycastle.jsl.its.jcajce.JcaITSContentVerifierProvider;
import org.bouncycastle.jsl.its.jcajce.JcaITSExplicitCertificateBuilder;
import org.bouncycastle.jsl.its.jcajce.JcaITSImplicitCertificateBuilderBuilder;
import org.bouncycastle.jsl.its.jcajce.JcaITSPublicVerificationKey;
...
import org.bouncycastle.jsl.oer.its.ieee1609dot2.Certificate;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.CertificateId;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.EndEntityType;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.IssuerIdentifier;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.PsidGroupPermissions;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.SequenceOfPsidGroupPermissions;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.SubjectPermissions;
...
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.BitmapSsp;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.CrlSeries;
...
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.Hostname;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.Psid;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.PsidSsp;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.PsidSspRange;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.PublicVerificationKey;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.SequenceOfPsidSsp;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.SequenceOfPsidSspRange;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.ServiceSpecificPermissions;
import org.bouncycastle.jsl.oer.its.ieee1609dot2.basetypes.SubjectAssurance;
...
//        };
        ...
        throws Exception
    {
        ...
        ITSImplicitCertificateBuilder certificateBuilder = new JcaITSImplicitCertificateBuilderBuilder().setProvider(JslTestProvider.name()).build(caCert, tbsBuilder);
        ...
        throws Exception
    {
        ...
        JcaJceHelper helper = new ProviderJcaJceHelper(Security.getProvider(JslTestProvider.name()));
        ...
        throws Exception
    {
        ...
        byte[] ca = Hex.decode("");
        ITSCertificate caCert = loadCertificate(ca);
        JcaITSContentVerifierProvider provider = new JcaITSContentVerifierProvider.Builder().setProvider(JslTestProvider.name()).build(caCert);
        ...
        provider = new JcaITSContentVerifierProvider.Builder().setProvider(JslTestProvider.name()).build(new ITSPublicVerificationKey((PublicVerificationKey)vki.getVerificationKeyIndicator()));
        ...
        throws Exception
    {
        ...
        //
        JcaITSContentVerifierProvider provider = new JcaITSContentVerifierProvider.Builder().setProvider(JslTestProvider.name()).build(rootCert);
        ...
        //
        provider = new JcaITSContentVerifierProvider.Builder().setProvider(JslTestProvider.name()).build(issuer);
