package org.bouncycastle.jsl.cms.test;
...
import org.bouncycastle.jsl.asn1.ASN1TaggedObject;
import org.bouncycastle.jsl.asn1.ASN1Util;
import org.bouncycastle.jsl.asn1.BERTags;
...
import org.bouncycastle.jsl.asn1.DLSequence;
import org.bouncycastle.jsl.asn1.bsi.BSIObjectIdentifiers;
import org.bouncycastle.jsl.asn1.cms.Attribute;
import org.bouncycastle.jsl.asn1.cms.AttributeTable;
import org.bouncycastle.jsl.asn1.cms.CMSAttributes;
import org.bouncycastle.jsl.asn1.cms.CMSObjectIdentifiers;
import org.bouncycastle.jsl.asn1.cms.ContentInfo;
import org.bouncycastle.jsl.asn1.cms.SignedData;
import org.bouncycastle.jsl.asn1.cms.SignerInfo;
import org.bouncycastle.jsl.asn1.cms.Time;
import org.bouncycastle.jsl.asn1.edec.EdECObjectIdentifiers;
import org.bouncycastle.jsl.asn1.ess.ESSCertIDv2;
import org.bouncycastle.jsl.asn1.ess.SigningCertificateV2;
import org.bouncycastle.jsl.asn1.nist.NISTObjectIdentifiers;
import org.bouncycastle.jsl.asn1.ocsp.OCSPResponse;
import org.bouncycastle.jsl.asn1.oiw.OIWObjectIdentifiers;
...
import org.bouncycastle.jsl.asn1.x509.IssuerSerial;
import org.bouncycastle.jsl.asn1.x509.X509ObjectIdentifiers;
import org.bouncycastle.jsl.asn1.x9.X9ObjectIdentifiers;
import org.bouncycastle.jsl.cert.X509AttributeCertificateHolder;
import org.bouncycastle.jsl.cert.X509CertificateHolder;
import org.bouncycastle.jsl.cert.jcajce.JcaCRLStore;
import org.bouncycastle.jsl.cert.jcajce.JcaCertStore;
import org.bouncycastle.jsl.cert.jcajce.JcaX509CRLHolder;
import org.bouncycastle.jsl.cert.jcajce.JcaX509CertificateConverter;
import org.bouncycastle.jsl.cert.jcajce.JcaX509CertificateHolder;
import org.bouncycastle.jsl.cert.ocsp.OCSPResp;
import org.bouncycastle.jsl.cert.test.SampleCredentials;
import org.bouncycastle.jsl.cms.CMSAbsentContent;
import org.bouncycastle.jsl.cms.CMSAlgorithm;
import org.bouncycastle.jsl.cms.CMSAttributeTableGenerationException;
...
import org.bouncycastle.jsl.cms.CMSSignedDataGenerator;
import org.bouncycastle.jsl.cms.CMSSignedDataParser;
...
import org.bouncycastle.jsl.cms.SignerInformation;
import org.bouncycastle.jsl.cms.SignerInformationStore;
import org.bouncycastle.jsl.cms.SignerInformationVerifier;
import org.bouncycastle.jsl.cms.SignerInformationVerifierProvider;
import org.bouncycastle.jsl.cms.jcajce.JcaSignerId;
import org.bouncycastle.jsl.cms.jcajce.JcaSignerInfoGeneratorBuilder;
import org.bouncycastle.jsl.cms.jcajce.JcaSimpleSignerInfoGeneratorBuilder;
import org.bouncycastle.jsl.cms.jcajce.JcaSimpleSignerInfoVerifierBuilder;
import org.bouncycastle.jsl.test.JslTestProvider;
import org.bouncycastle.jsl.operator.ContentSigner;
import org.bouncycastle.jsl.operator.DefaultDigestAlgorithmIdentifierFinder;
...
import org.bouncycastle.jsl.asn1.ASN1UTCTime;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        // Tamper the digestAlgorithm to a different *supported* digest (SHA-512 vs the
        // original SHA-256). BC's original used ripemd128 here, but JSL can't instantiate
        // RIPEMD128WITHRSA so it fails at content-verifier creation before reaching the
        // CMS-protection check this test targets. SHA-512 lets the verifier build and the
    ...
    public void testRawSHA256MissingNull()
        throws Exception
    {
        // rawsha256nonull.p7m carries an RSA PKCS#1 v1.5 signature whose embedded
        // DigestInfo omits the (RFC 8017 "SHOULD"-present) NULL parameter on the
        // digest AlgorithmIdentifier. BouncyCastle's own provider verifies it
        // leniently; JSL is backed by OpenSSL, which reconstructs the expected
        // DigestInfo *with* the NULL and so rejects the non-canonical encoding.
        // This is an intentional provider-behaviour difference, not a defect — the
        // test is inverted here to pin JSL's strict behaviour (and to flag if a
        // future JSL release starts accepting the lenient form).
        ...
        assertFalse("JSL/OpenSSL is expected to reject the missing-NULL DigestInfo encoding",
        ...
        throws Exception
    {
        ...
        assertTrue(org.bouncycastle.jsl.util.Arrays.areEqual(enc, ContentInfo.getInstance(enc).getEncoded(ASN1Encoding.DER)));
    ...
    private int invokeGetDigestOutputLength(AlgorithmIdentifier digAlgId)
        throws Exception
    {
        Class cmsUtils = Class.forName("org.bouncycastle.jsl.cms.CMSUtils");
    ...
    // DSA signing restored now that JSL provides DSA (see openssl-jostle DSA_SUPPORT.md).
...
//    }
    ...
    public void testEU()
        throws Exception
    {
        System.setProperty("org.bouncycastle.jsl.asn1.allow_wrong_oid_enc", "true");
        CMSSignedData cmsSignedData = new CMSSignedData(this.getInput("bc1639test.p7m"));
        System.setProperty("org.bouncycastle.jsl.asn1.allow_wrong_oid_enc", "false");
    }
    ...
    // Ported verbatim from upstream at 7301038b. The first three cover the guards taken in
    // the CMS parsers; upstream wrote them and this fork shipped the guards without them.
    // testEmptySignersRejected covers an attack shape - a certs-only SignedData carrying a
    // payload with no SignerInfos must not verify vacuously.
