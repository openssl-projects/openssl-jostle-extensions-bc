...
import org.bouncycastle.jsl.cms.CMSAuthEnvelopedDataParser;
import org.bouncycastle.jsl.cms.CMSAuthEnvelopedDataStreamGenerator;
import org.bouncycastle.jsl.cms.CMSEnvelopedDataParser;
import org.bouncycastle.jsl.cms.CMSEnvelopedDataStreamGenerator;
import org.bouncycastle.jsl.cms.CMSException;
import org.bouncycastle.jsl.cms.CMSSignedDataParser;
import org.bouncycastle.jsl.cms.CMSSignedDataStreamGenerator;
...
import org.bouncycastle.jsl.cms.jcajce.JceKeyTransAuthEnvelopedRecipient;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        org.bouncycastle.jsl.util.Store certStore = sp.getCertificates();

        for (Iterator it = signers.iterator(); it.hasNext(); )
        {
            SignerInformation signer = (SignerInformation)it.next();
            certCollection = certStore.getMatches(signer.getSID());
            org.bouncycastle.jsl.cert.X509CertificateHolder cert =
                (org.bouncycastle.jsl.cert.X509CertificateHolder)certCollection.iterator().next();
