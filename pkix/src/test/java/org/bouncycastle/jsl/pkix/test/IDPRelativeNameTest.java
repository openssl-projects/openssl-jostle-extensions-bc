    ...
    extends TestCase
{
    ...
    // org.bouncycastle.jsl.jce.provider is absent from the minimized core, so the fork ships no
        ...
        throws Exception
    {
        ...
        store.add(ee);
        store.add(crl);
        CertStore certStore = CertStore.getInstance("Collection", new CollectionCertStoreParameters(store));
