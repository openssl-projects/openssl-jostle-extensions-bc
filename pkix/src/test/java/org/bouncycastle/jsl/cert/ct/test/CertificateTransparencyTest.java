package org.bouncycastle.jsl.cert.ct.test;
...
import org.bouncycastle.jsl.cert.ct.SctExtension;
import org.bouncycastle.jsl.cert.ct.SignedCertificateTimestamp;
import org.bouncycastle.jsl.cert.ct.SignedCertificateTimestampDataV2;
import org.bouncycastle.jsl.cert.ct.SignedCertificateTimestampList;
import org.bouncycastle.jsl.cert.ct.TransItem;
import org.bouncycastle.jsl.cert.ct.TransItemList;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        extGen.addExtension(Extension.basicConstraints, true,
            new org.bouncycastle.jsl.asn1.x509.BasicConstraints(false));
