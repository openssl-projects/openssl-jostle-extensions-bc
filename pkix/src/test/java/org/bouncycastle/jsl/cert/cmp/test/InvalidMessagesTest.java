package org.bouncycastle.jsl.cert.cmp.test;
...
import org.bouncycastle.jsl.asn1.pkcs.CertificationRequest;
import org.bouncycastle.jsl.cert.CertIOException;
import org.bouncycastle.jsl.cert.X509CertificateHolder;
import org.bouncycastle.jsl.cert.cmp.CMPException;
import org.bouncycastle.jsl.cert.cmp.GeneralPKIMessage;
import org.bouncycastle.jsl.cert.cmp.ProtectedPKIMessage;
import org.bouncycastle.jsl.crypto.CryptoServicesRegistrar;
import org.bouncycastle.jsl.crypto.params.DSAParameters;
...
import org.bouncycastle.jsl.pkcs.PKCS10CertificationRequest;
import org.bouncycastle.jsl.pkcs.PKCSException;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        {
            Assert.assertEquals("malformed data: malformed body found: body type of 0 has incorrect type got: class org.bouncycastle.jsl.asn1.DERBitString", e.getMessage());
        }
    }
        ...
        throws Exception
    {
        ...
        {
            Assert.assertEquals("malformed data: malformed body found: body type of 15 has incorrect type got: class org.bouncycastle.jsl.asn1.DLSequence", e.getMessage());
        }
    }
        ...
        throws Exception
    {
        ...
        {
            Assert.assertEquals("malformed data: Invalid object: org.bouncycastle.jsl.asn1.DLSequence", e.getMessage());
        }
    }
