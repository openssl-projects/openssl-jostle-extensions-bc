package org.bouncycastle.jsl.cades.test;
...
import org.bouncycastle.jsl.asn1.esf.CommitmentTypeIdentifier;
import org.bouncycastle.jsl.asn1.esf.CommitmentTypeIndication;
import org.bouncycastle.jsl.asn1.esf.SignerLocation;
...
import org.bouncycastle.jsl.cades.CAdESSignedDataGenerator;
import org.bouncycastle.jsl.cades.CAdESSignerInfoGeneratorBuilder;
...
import org.bouncycastle.jsl.cms.test.CMSTestUtil;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        assertTrue(signer.verify(
            new org.bouncycastle.jsl.cms.jcajce.JcaSimpleSignerInfoVerifierBuilder()
        ...
        throws Exception
    {
        ...
        SignerLocation loc = new SignerLocation(
            new org.bouncycastle.jsl.asn1.DERUTF8String("AU"),
            new org.bouncycastle.jsl.asn1.DERUTF8String("Melbourne"),
            (org.bouncycastle.jsl.asn1.ASN1Sequence)null);
