...
import org.bouncycastle.jsl.asn1.pkcs.RSAPublicKey;
import org.bouncycastle.jsl.asn1.x509.AlgorithmIdentifier;
import org.bouncycastle.jsl.asn1.x509.DSAParameter;
...
import org.bouncycastle.jsl.pkcs.PKCS8EncryptedPrivateKeyInfo;
import org.bouncycastle.jsl.util.encoders.Hex;
import org.bouncycastle.jsl.util.io.pem.PemHeader;
import org.bouncycastle.jsl.util.io.pem.PemObject;
import org.bouncycastle.jsl.util.io.pem.PemObjectParser;
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                org.bouncycastle.jsl.asn1.sec.ECPrivateKey pKey = org.bouncycastle.jsl.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                org.bouncycastle.jsl.asn1.pkcs.RSAPrivateKey keyStruct = org.bouncycastle.jsl.asn1.pkcs.RSAPrivateKey.getInstance(seq);
