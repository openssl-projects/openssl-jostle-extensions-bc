...
import org.bouncycastle.jsl.cms.CMSEncryptedData;
...
public class PKCS12SafeBagFactory
{
        ...
        throws PKCSException
    {
        if (info.getContentType().equals(PKCSObjectIdentifiers.encryptedData))
        {
            CMSEncryptedData encData = new CMSEncryptedData(org.bouncycastle.jsl.asn1.cms.ContentInfo.getInstance(info));
