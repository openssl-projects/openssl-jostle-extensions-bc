...
import org.bouncycastle.jsl.asn1.x509.CRLValidatorException;
...
import org.bouncycastle.jsl.asn1.x509.PKIXCRLValidator;
import org.bouncycastle.jsl.jcajce.PKIXCRLStoreSelector;
import org.bouncycastle.jsl.jcajce.PKIXCertStoreSelector;
import org.bouncycastle.jsl.jcajce.PKIXExtendedBuilderParameters;
import org.bouncycastle.jsl.jcajce.PKIXExtendedParameters;
...
class RFC3280CertPathUtilities
{
        ...
        throws AnnotatedException
    {
        ...
        for (int i = 0; i < validCerts.size(); i++)
        {
            ...
            if (keyUsage == null)
            {
                if (Properties.isOverrideSet("org.bouncycastle.jsl.x509.allow_ca_without_crl_sign", true))
                {
