package org.bouncycastle.jsl.mozilla.jcajce;
...
import org.bouncycastle.jsl.mozilla.SignedPublicKeyAndChallenge;
    ...
    extends SignedPublicKeyAndChallenge
{
    ...
    private JcaSignedPublicKeyAndChallenge(org.bouncycastle.jsl.asn1.mozilla.SignedPublicKeyAndChallenge struct, JcaJceHelper helper)
    {
        super(struct);
        this.helper = helper;
    }
