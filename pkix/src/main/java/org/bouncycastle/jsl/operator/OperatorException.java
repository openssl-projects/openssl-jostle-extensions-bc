...
/**
 * Base checked exception for failures originating in the {@code org.bouncycastle.jsl.operator}
 * abstraction layer &mdash; the bridge between BC's JCA-free high-level packages
 * ({@code org.bouncycastle.jsl.cms}, {@code org.bouncycastle.jsl.cert}, {@code org.bouncycastle.jsl.pkcs},
 * etc.) and their underlying JCA / lightweight implementations
 * ({@code org.bouncycastle.jsl.operator.jcajce} / {@code org.bouncycastle.jsl.operator.bc}).
 * <p>
    ...
    extends Exception
{
     ...
     * or lightweight {@code org.bouncycastle.jsl.crypto.CryptoException}) that triggered the failure.
     *
