 ...
 *       {@link org.bouncycastle.jsl.cades.CAdESSignerInfoGeneratorBuilder} +
 *       {@link org.bouncycastle.jsl.cades.CAdESSignedDataGenerator}: a CMS
 ...
 *   <li><b>B-T</b> (T) &mdash;
 *       {@link org.bouncycastle.jsl.cades.CAdESSignatureTimestampUtil}: attaches
 *       an id-aa-signatureTimeStampToken unsigned attribute over the
 *       SignerInfo signature value.</li>
 *   <li><b>B-LT</b> (C-X-L) &mdash;
 *       {@link org.bouncycastle.jsl.cades.CAdESLongTermValuesUtil}: attaches the
 ...
 *       {@link org.bouncycastle.jsl.cades.CAdESArchiveTimestampUtil}: attaches an
 ...
 * </ul>
 * <p>
 * {@link org.bouncycastle.jsl.cades.CAdESLevelDetector} inspects a
 * {@link org.bouncycastle.jsl.cms.SignerInformation} and reports the attained
 ...
 * {@code org.bouncycastle.jsl.asn1.esf} and {@code org.bouncycastle.jsl.asn1.ess};
 * callers needing fine-grained control over a signature&apos;s shape can
 * build those directly and feed them to a standard
 * {@link org.bouncycastle.jsl.cms.CMSSignedDataGenerator}.
 */
