...
import org.bouncycastle.jsl.asn1.DLGenerator;
import org.bouncycastle.jsl.asn1.DLOctetStringGenerator;
import org.bouncycastle.jsl.asn1.DLSequenceGenerator;
import org.bouncycastle.jsl.asn1.DLTaggedObject;
...
//        }
     ...
     * {@link org.bouncycastle.jsl.operator.FixedLengthContentSigner} - RSA,
        ...
        throws CMSException, IOException
    {
        ...
        for (Iterator it = signerGens.iterator(); it.hasNext(); )
        {
            ...
            if (sigGen.getDigester() != null)
            {
                if (!org.bouncycastle.jsl.util.Arrays.areEqual(sigGen.getCalculatedDigest(), sigGen.getDigester().getDigest()))
                {
