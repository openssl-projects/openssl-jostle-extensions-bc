 ...
 *       {@link org.bouncycastle.jsl.asn1.x509.X509ObjectIdentifiers#id_pe_relatedCert}
 *       / {@link org.bouncycastle.jsl.asn1.x509.Extension#relatedCertificate}), and</li>
 ...
 * {@code org.bouncycastle.jsl.operator}, so both the lightweight (BC) and JCA
 * bindings of those operator interfaces are equally usable. Wrapping /
 * unwrapping the value as a PKCS#9 {@link org.bouncycastle.jsl.asn1.pkcs.Attribute}
 * lives on this class itself — see {@link #toAttribute(RequesterCertificate)}
 * and {@link #fromAttribute(org.bouncycastle.jsl.asn1.pkcs.Attribute)}.
 */
