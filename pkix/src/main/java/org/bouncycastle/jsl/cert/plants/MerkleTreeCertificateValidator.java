...
public class MerkleTreeCertificateValidator
{
     ...
     * {@link org.bouncycastle.jsl.operator.ContentSigner}) to avoid the parse +
     ...
     * {@code org.bouncycastle.jsl.crypto.io.DigestOutputStream} or
     ...
     * {@link org.bouncycastle.jsl.operator.ContentSigner}).
     */
    public static void writeEntryHashInput(
        byte[] tbsCertDer,
        byte[] extensionsWire,
