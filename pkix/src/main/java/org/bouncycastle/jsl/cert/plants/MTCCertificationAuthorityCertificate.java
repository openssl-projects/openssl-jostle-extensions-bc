package org.bouncycastle.jsl.cert.plants;
...
import org.bouncycastle.jsl.asn1.plants.MTCObjectIdentifiers;
...
import org.bouncycastle.jsl.asn1.x509.MTCCertificationAuthority;
 ...
 * the certificate &mdash; the caller supplies a {@link org.bouncycastle.jsl.operator.ContentSigner}
...
public final class MTCCertificationAuthorityCertificate
{
     ...
     * {@link X509v3CertificateBuilder#build(org.bouncycastle.jsl.operator.ContentSigner) build}
