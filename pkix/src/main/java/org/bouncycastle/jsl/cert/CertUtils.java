...
import org.bouncycastle.jsl.asn1.x509.AttributeCertificate;
import org.bouncycastle.jsl.asn1.x509.AttributeCertificateInfo;
...
import org.bouncycastle.jsl.asn1.x509.TBSCertList;
import org.bouncycastle.jsl.asn1.x509.TBSCertificate;
...
class CertUtils
{
    ...
    static boolean isAlgIdEqual(AlgorithmIdentifier id1, AlgorithmIdentifier id2)
    {
        ...
        if (Properties.isOverrideSet("org.bouncycastle.jsl.x509.allow_absent_equiv_NULL"))
        {
