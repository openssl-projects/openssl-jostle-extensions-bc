package org.bouncycastle.jsl.asn1.x509.test;
...
import org.bouncycastle.jsl.asn1.x509.PKIXNameConstraintValidator;
import org.bouncycastle.jsl.asn1.x509.NameConstraintValidatorException;
...
public class PKIXNameConstraintsTest
    extends SimpleTest
{
    /** SimpleTest subclasses are not discovered by gradle; this is the bridge. */
    @Test
    public void runsGreenUnderJUnit()
        throws Exception
    {
        TestResult result = new PKIXNameConstraintsTest().perform();
