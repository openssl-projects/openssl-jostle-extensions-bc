 ...
 * {@code getParameters()} link to the {@link org.bouncycastle.jsl.crypto.CipherParameters} it decorates,
 * so a caller supplies a nested chain ending in a key. The wrappers are
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithContext},
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithID},
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithRandom},
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithUKM},
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithIV},
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithSBox} and
 * {@link org.bouncycastle.jsl.crypto.params.ParametersWithSalt}.
 * <p>
 ...
 * <li>the key itself: {@link org.bouncycastle.jsl.crypto.params.KeyParameter} or an
 * {@link org.bouncycastle.jsl.crypto.params.AsymmetricKeyParameter}.</li>
 * </ul>
 ...
 * {@link org.bouncycastle.jsl.crypto.signers.ISO9796d2PSSSigner}, which accepts it as an alternative
 * to {@code ParametersWithRandom} rather than nested with it. A few GOST classes
 * ({@link org.bouncycastle.jsl.crypto.macs.GOST28147Mac} in particular) accept their wrappers in any
 ...
 * {@link org.bouncycastle.jsl.crypto.params.AEADParameters} is a self-contained alternative to
 * {@code ParametersWithIV} for AEAD modes and combines key, nonce, tag length and associated data
 * without nesting.
 */
package org.bouncycastle.jsl.crypto.params;
