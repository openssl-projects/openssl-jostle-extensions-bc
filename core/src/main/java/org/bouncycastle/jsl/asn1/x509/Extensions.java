    ...
    extends ASN1Object
{
     ...
     * "org.bouncycastle.jsl.x509.ignore_repeated_extensions" property still governs whether a
    ...
    private void parse(ASN1Sequence seq, List errors)
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            {
                if (!Properties.isOverrideSet("org.bouncycastle.jsl.x509.ignore_repeated_extensions"))
                {
