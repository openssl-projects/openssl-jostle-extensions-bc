...
import org.bouncycastle.jsl.util.AggregateRuntimeException;
    ...
    extends ASN1Object
{
     ...
     * (e.g. {@code org.bouncycastle.jsl.cert.X509CertificateReviewer}, github #1508); it does
    ...
    public ASN1Primitive toASN1Primitive()
    {
        if (seq != null)
        {
            if (Properties.getPropertyValue("org.bouncycastle.jsl.x509.allow_non-der_tbscert") != null)
            {
                if (Properties.isOverrideSet("org.bouncycastle.jsl.x509.allow_non-der_tbscert"))
                {
                    return seq;
                }
            }
