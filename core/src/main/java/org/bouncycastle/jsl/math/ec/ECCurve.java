...
import org.bouncycastle.jsl.math.Primes;
import org.bouncycastle.jsl.math.ec.endo.ECEndomorphism;
import org.bouncycastle.jsl.math.ec.endo.GLVEndomorphism;
import org.bouncycastle.jsl.math.field.FiniteField;
import org.bouncycastle.jsl.math.field.FiniteFields;
import org.bouncycastle.jsl.math.raw.Nat;
...
public abstract class ECCurve
{
    ...
    public static class Fp extends AbstractFp
    {
        ...
        public Fp(BigInteger q, BigInteger a, BigInteger b, BigInteger order, BigInteger cofactor, boolean isInternal)
        {
            ...
            {
                int maxBitLength = Properties.asInteger("org.bouncycastle.jsl.ec.fp_max_size", 1042); // 2 * 521
                int certainty = Properties.asInteger("org.bouncycastle.jsl.ec.fp_certainty", 100);
    ...
    public static abstract class AbstractF2m extends ECCurve
    {
        ...
        protected AbstractF2m(int m, int k1, int k2, int k3)
        {
            ...
            if (Properties.isOverrideSet("org.bouncycastle.jsl.ec.disable"))
            {
                throw new UnsupportedOperationException("F2M disabled by \"org.bouncycastle.jsl.ec.disable\"");
            }
            if (Properties.isOverrideSet("org.bouncycastle.jsl.ec.disable_f2m"))
            {
                throw new UnsupportedOperationException("F2M disabled by \"org.bouncycastle.jsl.ec.disable_f2m\"");
            }
        }
