 ...
 * version ({@link #ARGON2_VERSION_10}/{@link #ARGON2_VERSION_13}) constants take the values assigned
 * by RFC 9106; an optional secret (key) and additional/associated data may also be supplied per
 * RFC 9106.
 */
