    ...
    implements KeySpec, AlgorithmParameterSpec
{
    ...
    {
        // Validation/normalisation previously applied by org.bouncycastle.crypto.params.HKDFParameters:
        // IKM is required; salt is dropped (treated as absent) when null or empty; info defaults to
        // an empty array; all arrays are defensively cloned. Step-1 extract is never skipped here.
        if (ikm == null)
        {
