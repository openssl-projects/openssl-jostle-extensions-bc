...
import org.bouncycastle.jsl.asn1.pkcs.CertificationRequestInfo;
...
import org.bouncycastle.jsl.asn1.x509.X509AttributeIdentifiers;
...
public class C509CertificationRequest
{
        ...
        throws IOException
    {
        ...
        case C509Attribute.EXTENSION_REQUEST:
        {
            ...
            {
                x509Extensions = new Extensions(new org.bouncycastle.jsl.asn1.x509.Extension[0]);
            }
